import os
import logging
import Load_Current_BTC_End_of_Day_Prices_Into_GCS
...
CLUSTER_NAME = "move-btc-data"
CLUSTER_REGION = "us-central1"
PYSPARK_FILE = "Move_Current_BTC_Data_From_GCS_to_BigQuery.py"
...
with DAG(
    ...
    upload_BTC_data_to_datalake_task = PythonOperator(
    task_id="upload_BTC_data_to_datalake_task",
    ...
    upload_BTC_data_to_datalake_task >> create_cluster_dataproc_task >> submit_spark_job_task >> delete_cluster_dataproc_task >> trigger_dbt_cloud_job_run